...
## 预先下载的模型文件
+ backup_contentvec ：[checkpoint_best_legacy_500.pt](https://ser1ka.com/0:/backup/checkpoint_best_legacy_500.pt)
+ contentvec ：[checkpoint_best_legacy_500.pt](https://ibm.box.com/s/z1wgl1stco8ffooyatzdwsqn2psd9lrr)
  + 放在`hubert`目录下
+ 预训练底模文件： [G_0.pth](https://ser1ka.com/0:/backup/G_0.pth) 与 [D_0.pth](https://ser1ka.com/0:/backup/D_0.pth)
  + 放在`logs/44k`目录下
